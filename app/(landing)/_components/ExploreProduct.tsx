    ...
    <section className="w-full bg-[#F5F3F0] py-16 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="w-full lg:w-[35%] flex flex-col items-start">
          <h2 className="text-3xl md:text-4xl font-playfair text-[#1A1A1A] mb-6 uppercase tracking-wide">
            BOUTIQUES & CRÉATEURS
          </h2>
          <p className="text-[16px] font-playfair text-[#4A4A4A] leading-relaxed mb-8 italic">
